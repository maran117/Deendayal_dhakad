...
├⍟ Mʏ Nᴀᴍᴇ : <a href='https://t.me/TamilFlix_Admine_bot'>★彡[ᴛᴀᴍɪʟ ꜰʟɪx]彡★</a>
├⍟ Dᴇᴠᴇʟᴏᴘᴇʀ : <a href='https://t.me/TamilFlix_Admine_bot'>ᴛᴀᴍɪʟ ꜰʟɪx</a> 
...
ᴘʟᴇᴀꜱᴇ ꜱᴇɴᴅ ᴛʜᴇ ʀᴇǫᴜᴇꜱᴛ ᴀɢᴀɪɴ."""
    ...
    CUDNT_FND = """<b>𝑆𝑝𝑒𝑙𝑙𝑖𝑛𝑔 𝑀𝑖𝑠𝑡𝑎𝑘𝑒 𝐵𝑟𝑜 ‼️\n𝐷𝑜𝑛'𝑡 𝑊𝑜𝑟𝑟𝑦 😊 𝐶ℎ𝑜𝑜𝑠𝑒 𝑇ℎ𝑒 𝐶𝑜𝑟𝑟𝑒𝑐𝑡 𝑂𝑛𝑒 𝐵𝑒𝑙𝑜𝑤 👇\n\n<blockquote>கீழே கொடுக்கப்பட்டுள்ள விருப்பங்களிலிருந்து திரைப்படத்தின் பெயரின் சரியான  Spelling தேர்ந்தெடுக்கவும்.👇</blockquote></b>"""
...
3) ᴍᴏᴠɪᴇ ɪs ɴᴏᴛ ᴀᴠᴀɪʟᴀʙʟᴇ ɪɴ ᴛʜᴇ ᴅᴀᴛᴀʙᴀsᴇ ʀᴇᴘᴏʀᴛ ᴛᴏ ᴀᴅᴍɪɴs</b>"""
    ...
    MVE_NT_FND = """<b>𝑻𝒉𝒊𝒔 𝑴𝒐𝒗𝒊𝒆 𝑵𝒐𝒕 𝑭𝒐𝒖𝒏𝒅 𝑰𝒏 𝑴𝒚 𝑫𝒂𝒕𝒂𝑩𝒂𝒔𝒆...😌\n\n<blockquote>எனது 𝑫𝒂𝒕𝒂𝒃𝒂𝒔𝒆 இல் கண்டுபிடிக்க முடியவில்லை...😌</blockquote></b>"""
    

    TOP_ALRT_MSG = """ꜱᴇᴀʀᴄʜɪɴɢ ꜰᴏʀ ǫᴜᴇʀʏ ɪɴ ᴍʏ ᴅᴀᴛᴀʙᴀꜱᴇ..."""

    MELCOW_ENG = """<b>👋 ʜᴇʏ {},\n\n🍁 ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ\n🌟 {} \n\n📌 𝙎𝙚𝙖𝙧𝙘𝙝𝙞𝙣𝙜 𝘼𝙣𝙞𝙢𝙚 𝙁𝙤𝙧𝙢𝙖𝙩𝙚📌\n\n>𝙉𝙖𝙧𝙪𝙩𝙤 𝙎𝙝𝙞𝙥𝙥𝙪𝙙𝙚𝙣 𝙀143  ✅\n>𝙉𝙖𝙧𝙪𝙩𝙤 𝙎𝙝𝙞𝙥𝙥𝙪𝙙𝙚𝙣  ✅\n>𝙉𝙖𝙧𝙪𝙩𝙤 𝙎𝙝𝙞𝙥𝙥𝙪𝙙𝙚𝙣 𝙏𝙖𝙢𝙞𝙡 𝘿𝙪𝙗𝙗𝙚𝙙   ❌\n>𝙉𝙖𝙧𝙪𝙩𝙤 𝙎𝙝𝙞𝙥𝙥𝙪𝙙𝙚𝙣 𝙀𝙥𝙞𝙨𝙤𝙙𝙚 23  ❌\n\n💫 𝙊𝙣𝙡𝙮 𝙩𝙮𝙥𝙚 𝙖𝙣𝙞𝙢𝙚 𝙣𝙖𝙢𝙚  𝙖𝙛𝙩𝙚𝙧 𝙮𝙤𝙪 𝙬𝙞𝙡𝙡 𝙨𝙚𝙡𝙚𝙘𝙩  𝙎𝙚𝙧𝙞𝙚𝙨 𝙖𝙣𝙙 𝙚𝙥𝙞𝙨𝙤𝙙𝙚💫\n⚙️ 𝖭ᴏᴛᴇ :- 𝖠ʟʟ ᴍᴇ𝗌𝗌ᴀɢᴇ𝗌 ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏ-ᴅᴇʟᴇᴛᴇᴅ ᴀғᴛᴇʀ 𝟷𝟶 ᴍɪɴᴜᴛᴇ𝗌 ᴛᴏ ᴀᴠᴏɪᴅ ᴄᴏᴘʏʀɪɢʜᴛ ɪ𝗌𝗌ᴜᴇ𝗌.</b>"""
...
➢ QR Cᴏᴅᴇ : <a href='https://envs.sh/5H7.jpg'>𝑪𝑳𝑰𝑪𝑲 𝑯𝑬𝑹𝑬 𝑻𝑶 𝑺𝑪𝑨𝑵</a>

➢ Uᴘɪ Iᴅ : <code>maran3377-1@okicici</code>
...
Mᴇꜱꜱᴀɢᴇ : <b>{}</b>"""
    ...
    CAPTION = """<b>📂Fɪʟᴇɴᴀᴍᴇ :@TamilFlix_Mv {file_name}
...
🛠️ Bᴜɪʟᴅ Sᴛᴀᴛᴜs: <code>v4.2 [ v4.2 ★彡[ᴛᴀᴍɪʟ ꜰʟɪx]彡★ ]</code>
</b>"""
...
👨‍💻 ᴄᴏɴᴛᴀᴄᴛ ᴛʜᴇ <a href='https://t.me/TamilFlix_Admine_bot'>Owner</a> ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ᴛʀɪᴀʟ.
...
💵 ᴜᴘɪ ɪᴅ - <code>maran3377-1@okicici</code>
...
📸 ǫʀ ᴄᴏᴅᴇ - <a href='https://envs.sh/5H7.jpg'>ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ꜱᴄᴀɴ</a>
...
𝑼𝑷𝑰 𝑰𝑫 👉 <code>maran3377-1@okicici</code>

𝑸𝑹 𝒄𝒐𝒅𝒆 👉 <a href='https://envs.sh/5H7.jpg'>ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ꜱᴄᴀɴ</a> 
