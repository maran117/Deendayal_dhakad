...
BOT_TOKEN = environ.get('BOT_TOKEN', "7917056870:AAGwijM0A7bmm3XA3N1fDoBLbUejKaYAkoo")
...
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002457425264 -1002401488764')) #Notification of those who verify will be sent to your channel. Enter the ID of the channel you want to send notification to here.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://hi:mWirsMP0ELYvNBn6@cluster0.1ybqm.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
