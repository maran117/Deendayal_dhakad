...
BOT_TOKEN = environ.get('BOT_TOKEN', "8040663206:AAFUKUhhqvgLQstpkiAVGHztUR8rhf2jI-k")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002023479054').split()] #Channel id for auto indexing ( make sure bot is admin )
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002189233525')) #Log channel id ( make sure bot is admin )
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002457425264')) #Notification of those who verify will be sent to your channel. Enter the ID of the channel you want to send notification to here.
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002189233525')) # add premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1002023479054') #Channel / Group Id for force sub ( make sure bot is admin )
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', 'https://tasteless-elicia-marankk-604d096b.koyeb.app/'))
FQDN = str(getenv('FQDN', BIND_ADRESS)) if not ON_HEROKU or getenv('FQDN') else APP_NAME+'.herokuapp.com'
URL = "https://tasteless-elicia-marankk-604d096b.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://tasteless-elicia-marankk-604d096b.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://tasteless-elicia-marankk-604d096b.koyeb.app/".format(FQDN)
else:
    URL = "https://tasteless-elicia-marankk-604d096b.koyeb.app/".format(FQDN)
