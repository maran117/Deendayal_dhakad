...
async def start(client, message):
    ...
    if len(message.command) != 2:
        ...
        if curr_time < 12:
            ...
            gtxt = "ɢᴏᴏᴅ ɴɪɢʜᴛ 👋"
        m=await message.reply_text("<i>ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ <b>★彡[ᴛᴀᴍɪʟ ꜰʟɪx]彡★</b>.\nʜᴏᴘᴇ ʏᴏᴜ'ʀᴇ ᴅᴏɪɴɢ ᴡᴇʟʟ...</i>")
    ...
    if AUTH_CHANNEL and not await is_req_subscribed(client, message):
        ...
        await client.send_photo(
            ...
            caption="**📌📌 READ INSTRUCTIONS 📌📌 \n\n 📢 நீங்கள் கேட்கும் மூவி  தேவை என்றால், கீழே உள்ள 📥 Movies Channel - லில் சேர வேண்டும் 👇✅ \n\nஅந்த மூவீஸ் சேனலில் இணைந்த பிறகு இந்த BOT - Ku வாருங்கள்👍 🔄 Try Again Button கிளிக் செய்யவும் ✅ \n\nஅப்போது உங்கள் மூவி வரும் இங்கே ✅👇 \n\n❗️ᴘʟᴇᴀꜱᴇ ᴊᴏɪɴ ᴍʏ ᴍᴏᴠɪᴇꜱ ᴄʜᴀɴɴᴇʟ ᴛᴏ ᴜꜱᴇ ᴛʜɪꜱ ʙᴏᴛ 👇 \n\n📥 ᴀꜰᴛᴇʀ ᴊᴏɪɴᴇᴅ ᴍᴏᴠɪᴇꜱ ᴄʜᴀɴɴᴇʟ ᴄᴏᴍᴇʙᴀᴄᴋ ᴛᴏ ᴛʜɪꜱ ʙᴏᴛ👇 ᴄʟɪᴄᴋ ᴛʀʏ ᴀɢᴀɪɴ ʙᴜᴛᴛᴏɴ ʏᴏᴜʀ ᴀꜱᴋᴇᴅ ꜰɪʟᴇ ᴡɪʟʟ ᴄᴏᴍᴇ ✅...**",
    ...
    if len(message.command) == 2 and message.command[1] in ["premium"]:
        buttons = [[
                    InlineKeyboardButton('📲 ꜱᴇɴᴅ ᴘᴀʏᴍᴇɴᴛ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ', user_id=int(6594043398))
                  ],[
    ...
    if data.split("-", 1)[0] == "BATCH":
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [
                                InlineKeyboardButton('📌 ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ 📌', url=f'https://t.me/TamilFlix_Mv') #Don't change anything without contacting me @LazyDeveloperr
                            ]
                        ]
                    )
                )
        ...
        if is_valid == True:
            ...
            await message.reply_photo(
                ...
                caption=f"<b>Hey {message.from_user.mention},\n\n𝑌𝑜𝑢 𝐴𝑟𝑒 𝑆𝑢𝑐𝑐𝑒𝑠𝑠𝑓𝑢𝑙 𝑉𝑒𝑟𝑖𝑓𝑖𝑒𝑑✅ ! 𝑁𝑜𝑤 𝑌𝑜𝑢 𝐻𝑎𝑣𝑒 𝑈𝑛𝑙𝑖𝑚𝑖𝑡𝑒𝑑 𝐴𝑐𝑐𝑒𝑠𝑠 𝐹𝑜𝑟 24 𝐻𝑜𝑢𝑟𝑠.\n\n<blockquote>நீங்கள் வெற்றிகரமாக ✅சரிபார்க்கப்பட்டுவிட்டீர்கள், இப்போது நீங்கள் 24 மணிநேரத்திற்கு 𝐷𝑖𝑟𝑒𝑐𝑡 𝑀𝑜𝑣𝑖𝑒 இன் 𝐹𝑖𝑙𝑒𝑠 பெறலாம்</blockquote></b>",
                reply_markup=InlineKeyboardMarkup(btn)
            )
    ...
    msg = await client.send_cached_media(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
             ...
             [
              InlineKeyboardButton('📌 ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ 📌', url=f'https://t.me/TamilFlix_Mv') #Don't change anything without contacting me https://t.me/Sorry_Sorry_Galti_Ho_Gai
             ]
            ]
        )
    )
